    ...
    //read data and send
     ...
     Serial.println(outputString);
      ...
      if (flash.readStr(rightArmCountAddr, outputString)) { //read function
        ...
        while (!flash.eraseSector(stepCountAddr));
     
         while (!flash.eraseSector(stepWidthAddr));
     
         while (!flash.eraseSector(sessionTimeAddr));
     
         while (!flash.eraseSector(leftArmCountAddr));
     
         while (!flash.eraseSector(rightArmCountAddr));
