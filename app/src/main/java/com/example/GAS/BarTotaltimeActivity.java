...
public class BarTotaltimeActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bar_totaltime);
        ...
        int sessionTime = Integer.parseInt(sharedpreferences.getString("sessionTime", "1500"));
        ...
        NoOfEmp.add(new BarEntry(sessionTime, 5));
        ...
        BarDataSet bardataset = new BarDataSet(NoOfEmp, "Total Session Time");
